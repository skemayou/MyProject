...
class BrandColors {
  static Color get prussianBlue => const Color(0xFF1CC4BF);

  static Color get prussianBlueDark => const Color(0xFF1CC4BF);

  static Color get bitterSweet => const Color(0xFFFFFFFF);
}
